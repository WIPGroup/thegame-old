...
<head>
	...
	<script async src="bower_components/offline/offline.min.js"></script>
	<!-- Bootstrap -->
	...
	<script async src="bower_components/bootswatch-dist/js/bootstrap.min.js"></script>
	<!-- DataTables -->
	<link rel="stylesheet" type="text/css" href="bower_components/datatables/media/css/jquery.dataTables.min.css">
	<script async type="text/javascript" charset="utf8" src="bower_components/datatables/media/js/jquery.dataTables.min.js"></script>
	<!-- SweetAlert -->
	<script async src="bower_components/sweetalert/dist/sweetalert.min.js"></script>
	...
	<script async src="bower_components/nouislider/distribute/jquery.nouislider.all.min.js"></script>
	<!-- bootstrap-select -->
