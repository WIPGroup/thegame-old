<?php
	...
	while ($zaznam = mysql_fetch_array($vysledek)) {
		echo '<button class="btn btn-default" title="'.$zaznam['nazev'].'"><span class="badge">'.$vlastnictvi[$zaznam['idveci']].'</span> <img id="item" src="icons/'.$zaznam['nazev'].'.png"></img></button>'; //'<tr><td>'.$zaznam['nazev'].'</td><td>'.$vlastnictvi[$zaznam['idveci']].'</td></tr>';
	} //</table>
	echo '</div></div>';
?>
