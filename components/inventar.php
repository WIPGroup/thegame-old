<?php
	...
	echo '<div class="panel panel-primary"><div class="panel-heading"><h2 class="panel-title">Inventář:</h2></div><ul class="list-group" style="text-align: left">';//<table style="background-color: #fff" class="table table-bordered table-responsive table-hover"><tr><td>Peniaze</td><td>'.$vlastnictvi[0].'</td></tr>';
