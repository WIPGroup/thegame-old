...
while ($zaznam = mysql_fetch_array($vysledek))
{
	...
	echo '<td id="tableimage" style="background-image:url(icons/' . $veci[$zaznam['nabizi']] . '.png)" data-toggle="tooltip" data-placement="left" title data-original-title="' . $veci[$zaznam['nabizi']] . '"><span class="badge">' . $zaznam['mnoznabizi'] . '</span><span class="sr-only">' . $veci[$zaznam['nabizi']] . '</span></td>';

	echo '<td id="tableimage" style="background-image:url(icons/' . $veci[$zaznam['chce']] . '.png)" data-toggle="tooltip" data-placement="left" title data-original-title="' . $veci[$zaznam['chce']] . '"><span class="badge">' . $zaznam['mnozchce'] . '</span><span class="sr-only">' . $veci[$zaznam['chce']] . '</span></td>';
...
echo '<div id="mojecontainer"><table id="moje"><tr><td>moje<td></tr></table></div>';  //TODO jura udělej to stejně jako tu horní tabulku s tím že template je takový: tabulce dáš id moje a dáš ji do divu s id mojecontainer, nachystal jsem ti to tady
?>
