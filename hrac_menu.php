<ul class="nav navbar-nav navbar-right" style="padding-right: 15px">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo 'Username'; //TODO: PHP magick - jirvoz saw this ?><span class="caret"></span></a>
