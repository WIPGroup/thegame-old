...
while ($zaznam = mysql_fetch_array($vysledek))
{
	...
	echo '<td id="tableimage" style="background-image:url(icons/' . $veci[$zaznam['nabizi']] . '.png)" data-toggle="tooltip" data-placement="top" title="' . $veci[$zaznam['nabizi']] . '">' . $zaznam['mnoznabizi'] . '<span class="sr-only">' . $veci[$zaznam['nabizi']] . '</span></td>';

	echo '<td id="tableimage" background="icons/' . $veci[$zaznam['chce']] . '.png" data-toggle="tooltip" data-placement="top" title="' . $veci[$zaznam['chce']] . '">' . $zaznam['mnozchce'] . '<span class="sr-only">' . $veci[$zaznam['chce']] . '</span></td>';
