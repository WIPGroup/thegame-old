<?php
	...
	while ($zaznam = mysql_fetch_array($vysledek)) {
		echo '<button class="btn btn-default"><span class="badge">'.$vlastnictvi[$zaznam['idveci']].'</span>'.$zaznam['nazev'].'</button><br>'; //'<tr><td>'.$zaznam['nazev'].'</td><td>'.$vlastnictvi[$zaznam['idveci']].'</td></tr>';
	} //</table>
	echo '</div></div>';
?>
